...
bool Graphics::Initialize(int width, int height)
{
  ...
  { 
    solarObject.push_back(new Object());

  }

//Sun
  solarObject[0]->setOrbit(0);
  solarObject[0]->setScale(1.5);
  solarObject[0]->setRotationSpeed(.25);


//Earth
  solarObject[1]->setOrbit(5);
  solarObject[1]->setScale(.75);
  solarObject[1]->setParent(solarObject[0]);
  solarObject[1]->setOrbitSpeed(.5);
  solarObject[1]->setRotationSpeed(1);

//Earths Moon
  solarObject[2]->setOrbit(2);
  solarObject[2]->setScale(.33);
